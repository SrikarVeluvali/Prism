      ...
      <div className="auth-content">
        <div className="auth-left">
          <div className="auth-branding">
            <img src="/logo.png" alt="PRISM Logo" className="auth-brand-logo" />
            <h1 className="auth-brand-title">PRISM</h1>
            <p className="auth-brand-tagline">AI-Powered Learning Platform</p>
          </div>

    ...
    def extract_text(self, url: str) -> str:
        ...
        try:
            ...
            try:
                ...
                transcript = transcript_list._manually_created_transcripts[0] if transcript_list._manually_created_transcripts else transcript_list._generated_transcripts[0]
